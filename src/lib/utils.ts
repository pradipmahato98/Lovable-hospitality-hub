 ...
 * @param length The length of the random data in bytes.
 */
 ...
 * Note: Uses modulo which has a very slight bias for large ranges not power of 2,
 * but sufficient for common ERP use cases like 6-digit codes.
 */
