 ...
 * @param bytes - Number of random bytes to generate (output will be 2x this length).
 */
 ...
 * Uses rejection sampling to ensure a uniform distribution and avoid modulo bias.
 */
