...
import {
  ...
  ChevronRight, ArrowRight, Wallet, TrendingUp, Filter, Share2, MoreHorizontal,
...
const HRM = () => {
  ...
  const dashboardData = useMemo(() => {
    ...
    // Fix: Find the explicit 'Gross salary' value instead of summing all items (which includes both total and line items)
    const grossItem = scaledEarnings.find(e => e.label === "Gross salary");
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 p-2">
            ...
            <div className="flex-1 space-y-1">
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-1">
                ...
                <div className="flex items-center gap-1.5 text-[12px] text-slate-400 italic">
            ...
            <TabsContent value="payroll_finance" className="space-y-6">
              ...
              <Card className="border-none shadow-sm rounded-2xl bg-white overflow-hidden">
                <CardHeader className="flex flex-row items-center justify-between py-4 px-6 border-b border-slate-50">
                  ...
                  <div className="p-2 bg-[#E8F5E9] rounded-lg" style={{ backgroundColor: HRM_COLORS.mint.bg }}>
              ...
              <Card className="border-none shadow-sm rounded-2xl bg-white overflow-hidden">
                ...
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    {[
                      { label: "Earnings", value: dashboardData.payrollSummary.earnings, icon: ArrowUpRight, iconColor: "text-[#4CAF50]", iconBg: "bg-[#E8F5E9]" },
                      { label: "Additions", value: dashboardData.payrollSummary.additions, icon: ArrowUpRight, iconColor: "text-[#4CAF50]", iconBg: "bg-[#E8F5E9]" },
                      { label: "Deductions", value: dashboardData.payrollSummary.deductions, icon: ArrowDownRight, iconColor: "#E53935", iconBg: "bg-red-50", iconBorder: "border-red-100" },
                      { label: "Benefit", value: dashboardData.payrollSummary.benefit, suffix: "%", badge: "Company", icon: ArrowUpRight, iconColor: "text-[#4CAF50]", iconBg: "bg-[#E8F5E9]" },
                      { label: "Net Payable", value: dashboardData.payrollSummary.netPayable, icon: ArrowUpRight, iconColor: "text-[#4CAF50]", iconBg: "bg-[#E8F5E9]" },
                    ].map((metric) => (
                        ...
                        <div className="flex items-center justify-between">
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-1.5 mt-2">
                              ...
                              {metric.badge && (
                                <Badge className="bg-purple-100 text-purple-600 hover:bg-purple-100 border-none px-1.5 py-0 rounded-md text-[9px] font-extrabold h-3.5">
                                  {metric.badge}
                                </Badge>
                              )}
                            </div>
                          </div>
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 border-white shadow-sm ${metric.iconBg}`}>
                            <metric.icon className={`w-4 h-4 ${metric.label === "Deductions" ? "" : metric.iconColor}`} color={metric.label === "Deductions" ? "#E53935" : undefined} />
                          </div>
                        </div>
                      </div>
                    ))}
                    ...
                    <Table>
                      <TableHeader className="bg-slate-50/80">
                        <TableRow className="hover:bg-transparent border-slate-100">
                          <TableHead className="w-[18%] font-extrabold text-slate-700 text-[13px] h-12">Country</TableHead>
                          ...
                          <TableHead className="w-[10%] font-extrabold text-slate-700 text-[13px] h-12">Payable</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        <TableRow className="border-none hover:bg-transparent align-top">
                            ...
                            <div className="space-y-4 py-6 px-6">
                              {dashboardData.salaryProfile.earnings.map(e => (
                                <div key={e.label} className="flex justify-between items-center">
                                  ...
                                  <span className="text-[12px] text-slate-700 font-extrabold">{e.value.toFixed(2)}</span>
                                </div>
                              ))}
                            </div>
                          </TableCell>
                          <TableCell className="p-0 border-r border-slate-50/50">
                            <div className="space-y-4 py-6 px-6">
                              ...
                              <div className="flex justify-between items-center pt-4 border-t border-slate-100">
                                ...
                                <span className="text-[12px] text-slate-800 font-extrabold">{dashboardData.payrollSummary.additions.toLocaleString()}.00</span>
                              </div>
                            </div>
                          </TableCell>
                          <TableCell className="p-0 border-r border-slate-50/50">
                            <div className="space-y-4 py-6 px-6">
                              ...
                              <div className="flex justify-between items-center pt-4 border-t border-slate-100">
                                <span className="text-[12px] text-slate-800 font-extrabold">Total</span>
                                <span className="text-[12px] text-slate-800 font-extrabold">{dashboardData.payrollSummary.deductions.toLocaleString()}.00</span>
                              </div>
                            </div>
                          </TableCell>
                          ...
                          <TableCell className="py-6 px-6">
                            <span className="text-[13px] font-extrabold text-slate-800">{dashboardData.salaryProfile.payable.toLocaleString()}.00</span>
                          </TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
