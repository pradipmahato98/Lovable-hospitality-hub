...
export function BanquetCalendar({ events, onEventClick, onDateClick }: BanquetCalendarProps) {
        ...
        <div className="grid grid-cols-7 gap-1">
          {calendarDays.map((day, index) => {
            ...
            return (
              <div
                key={day}
                className={`h-24 p-1 rounded-lg border transition-colors cursor-pointer hover:bg-secondary/50 ${
                    ...
                    {dayEvents.slice(0, 2).map((event) => (
                      <Tooltip key={event.id}>
                        <TooltipTrigger asChild>
                          <div
                            className={`text-xs p-1 rounded truncate border-l-2 bg-secondary/50 cursor-pointer hover:bg-secondary ${
