    ...
    <DialogPortal>
      ...
      >
        <div className="relative h-full w-full">
          {children}
          <DialogPrimitive.Close className="absolute right-[-12px] top-[-12px] rounded-full bg-background border shadow-md p-1 opacity-100 transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 z-[60]">
            <X className="h-4 w-4" />
