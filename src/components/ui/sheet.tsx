      ...
      <SheetPortal>
        ...
        >
          <div className="relative flex flex-col h-full w-full overflow-hidden">
            ...
            <SheetPrimitive.Close className="absolute right-3 top-3 h-8 w-8 rounded-full bg-background/80 flex items-center justify-center border shadow-sm transition-all hover:bg-accent hover:scale-105 active:scale-95 z-50">
