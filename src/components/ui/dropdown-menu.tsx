  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        {...otherProps}
      >
        <div className="flex items-center justify-between px-2 py-1 bg-muted/50 border-b mb-1">
          <span className="text-[10px] font-bold text-muted-foreground uppercase">Options</span>
          <DropdownMenuPrimitive.Item
            className="p-0.5 rounded-full hover:bg-destructive/10 hover:text-destructive cursor-pointer"
            onSelect={(e) => {
