    ...
    <DropdownMenuPrimitive.Portal>
      ...
      >
        <div className="flex items-center justify-between px-2 py-1.5 bg-muted/30 border-b mb-1">
          <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-tight ml-1">Menu Options</span>
          <DropdownMenuPrimitive.Item
            className="h-6 w-6 flex items-center justify-center rounded-full hover:bg-destructive/10 hover:text-destructive cursor-pointer transition-colors focus:bg-destructive/10 focus:text-destructive"
            onSelect={(e) => {
              setClosing();
            }}
          >
